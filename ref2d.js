...
/* ------------------ Agenda Palpa — Macarena Valdés Domínguez ------------------ */
{
  ...
  keywords: ["salud", "tecnología", "medicina"],
  title: "Agenda Palpa",
...
/* ------------------ DENSE — Vicente Carmona ------------------ */
{
  ...
  orientation: "v",
  span: 1,
  tags: ["producto","industrial","investigación", "tecnología"],
  title: "DENSE",
...
/* ------------------ Silla Mudra — Chiara Antillo Heilenkötter ------------------ */
{
  ...
  orientation: "v",
  span: 1,
  tags: ["producto","industrial","objeto","mobiliario"],
  title: "Silla Mudra",
...
/* ------------------ Hacer y componer — Francisco Gálvez ------------------ */
{
  ...
  orientation: "v",
  span: 1,
  tags: ["investigación","publicación académica", "tipografía"],
...
/* ------------------ Theragun PRO Plus - By Therabody — Nicolás Robertson ------------------ */
{
  ...
  orientation: "h",
  span: 1,
  tags: ["objeto","producto", "tecnología"],
...
/* ------------------ PHOTOVOLTAIC TRAINING BENCH — Nicolás Robertson ------------------ */
{
  ...
  orientation: "h",
  span: 1,
  tags: ["diseño conceptual", "tecnología"],
...
/* ------------------ Línea de Ensamble — Vicente Múñoz ------------------ */
{
  ...
  role: "Diseñador",
  collab: "Profesor Guía: Nicolás Morales",
...
/* ------------------ Viajes Lectores — Victoria Garcia ------------------ */
{
  ...
  url: "https://victoriagarciast.myportfolio.com/viajes-lectores"
    ...
    /* ------------------ Señalética Club Manquehue — Carolina Correa ------------------ */
    {
      ...
      orientation: "h",
      span: 1,
      tags: ["wayfinding", "diseño de información"],
    ...
    /* ------------------ Coleccion 3 Chol1; Bichos — Martín Campos ------------------ */
    {
      ...
      orientation: "h",
      span: 1,
      tags: ["producto", "industrial", "mobiliario"],
      keywords: ["cnc"],
    ...
    /* ------------------ The Master Knife — Eduardo Romo ------------------ */
    {
      ...
      orientation: "h",
      span: 1,
      tags: ["3d", "audiovisual", "tecnología"],
    ...
    /* ------------------ Ángela - Set — María Granifo Correa ------------------ */
    {
      ...
      orientation: "h",
      span: 1,
      tags: ["objeto", "industrial", "mobiliario"],
      keywords: ["decoración"],
      title: "Ángela - Set",
